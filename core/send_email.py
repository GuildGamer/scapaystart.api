...
def send_email(recepient, name) -> None:
    ...
    <body style="margin: auto; text-align: center; background-color: #FFFFFF; transition: 0.3s; padding: 5px 10px; color: #2d3092;">
       ...
       <p>
       <img style="height: 24px;width: 24px;" src="https://scapaystatic.fra1.digitaloceanspaces.com/instagram.png" href="" alt="instagram">
       <img style="height: 24px;width: 24px;" src="https://scapaystatic.fra1.digitaloceanspaces.com/twitter.png" href="" alt="twitter">
       <img style="height: 24px;width: 24px;" src="https://scapaystatic.fra1.digitaloceanspaces.com/facebook.png" href="" alt="facebook">
       </p>
    </body>
    </html>
    """
